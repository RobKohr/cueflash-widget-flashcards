$(document).ready(function(){
    ...
    $.ajax({ url: assets_url + 'RobKohr/cueflash-widget-flashcards/master/widget.html', 
        success: function(data) { 
            $('#widget-content-area').html(data); 
            var script_url = assets_url + 'RobKohr/cueflash-widget-flashcards/master/widget.js';
